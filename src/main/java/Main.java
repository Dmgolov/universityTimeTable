...
public class Main {
    public static void main(String[] args) {
        ...
        storage.addSubject(new Subject("Physics", 2, "16:00", "17:30"));
*/
...
//        System.out.println(ChronoUnit.SECONDS.between(LocalTime.of(10, 30), LocalTime.of(10, 30)));
        ...
        storage.addSubject(new Subject("Algoritmid ja andmestruktuurid (ITI0050) loeng", 0, "10:00", "11:30"));
        storage.addSubject(new Subject("Algoritmid ja andmestruktuurid (ITI0050) praktikum", 2, "8:00", "9:30"));
        storage.addSubject(new Subject("Algoritmid ja andmestruktuurid (ITI0050) praktikum", 2, "16:00", "17:30"));
//        storage.addSubject(new Subject("Algoritmid ja andmestruktuurid (ITI0050) harjutus", 2, "8:00", "9:30"));
//        storage.addSubject(new Subject("Algoritmid ja andmestruktuurid (ITI0050) harjutus", 4, "14:00", "15:30"));
        storage.addSubject(new Subject("Automaatjuhtimissüsteemid (ISS0121) loeng", 1, "14:00", "15:30"));
        ...
        storage.addSubject(new Subject("Andmebaasid II (IDU0230) harjutus", 1, "12:00", "13:30"));
        storage.addSubject(new Subject("Andmebaasid II (IDU0230) harjutus", 2, "10:00", "11:30"));
        storage.addSubject(new Subject("Andmebaasid II (IDU0230) harjutus", 2, "12:00", "13:30"));
        storage.addSubject(new Subject("Veebiteenused (IDU0075) loeng", 1, "9:50", "11:20"));
        storage.addSubject(new Subject("Veebiteenused (IDU0075) praktikum", 1, "14:00", "15:30"));
        storage.addSubject(new Subject("Väljendusoskus (ISS0110) loeng", 1, "12:00", "13:30"));
...
//        storage.addSubject(new Subject("Väljendusoskus (ISS0110) harjutus", 3, "11:30", "13:45"));
        storage.addSubject(new Subject("Loogiline programmeerimine (ITI0021) loeng", 2, "10:00", "11:30"));
